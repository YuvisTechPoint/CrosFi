...
export function BlogHero() {
  ...
  const stats = [
    { icon: BookOpen, value: "25+", label: "Articles Published" },
    { icon: Calendar, value: "Weekly", label: "New Content" },
    { icon: User, value: "10K+", label: "Monthly Readers" },
  ]
      ...
      >
        ...
        <motion.div variants={itemVariants} className="mb-6">
          <div className="inline-flex items-center gap-2 px-4 py-2 bg-primary/10 border border-primary/20 rounded-full">
            ...
            <span className="text-sm font-medium text-primary">Latest Updates & Insights</span>
          </div>
        </motion.div>
        ...
        >
          Stay updated with the latest developments in DeFi, blockchain technology, and the future of decentralized lending.
        </motion.p>
