...
export function CommunityHero() {
  ...
  const stats = [
    ...
    { icon: MessageCircle, value: "24/7", label: "Chat" },
    { icon: Calendar, value: "Weekly", label: "Events" },
  ...
  return (
    <section className="relative min-h-[60vh] flex items-center justify-center overflow-hidden pt-20">
      ...
      >
        ...
        >
          Connect with developers, users, and DeFi enthusiasts. Share ideas, get support, and help shape the future of fixed-rate lending.
        </motion.p>
